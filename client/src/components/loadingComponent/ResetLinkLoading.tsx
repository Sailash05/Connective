    ...
    return(
        <div className="flex items-center justify-center h-[100dvh] w-[100dvw] fixed top-0 left-0 z-50 bg-black bg-opacity-30">
            <div className="text-center bg-white md:p-14 p-10 rounded-xl shadow-md max-sm:w-[90dvw]">
                ...
                <h2 className="text-lg font-semibold text-gray-700 mt-8">Sending Reset Link to your email...</h2>
                <p className="text-sm text-gray-500 mt-2">Please wait while we generate your secure reset token.</p>
            </div>
        </div>
    );
}
