...
import profileIcon from '../../assets/mainPageImages/account.png'
...
const Header = () => {
    ...
    return(
         <header className="flex justify-between py-3 px-16 border border-b-4">
            ...
            <div className='flex justify-center items-center basis-1/3'>
                <div className='relative flex justify-center items-center'>
                    <input type="text" placeholder='Search...' className='p-2 pl-5 w-[350px] rounded-full bg-gray-200 focus:outline-blue-600 placeholder:text-black' />
            ...
            <div className='flex justify-end items-center gap-4 basis-1/3'>
                ...
                <button className='p-2 bg-fuchsia-400 shadow-md bg-gradient-to-r from-[#FF512F] via-[#F09819] to-[#FF512F] bg-[length:200%_auto] transition-all duration-500 hover:bg-right rounded-lg'><img src={createPostIcon} alt="" width={20} className='invert' /></button>

                <button className='text-2xl p-2'><MdOutlineMessage /></button>

                <button className='text-2xl p-1'><IoMdNotifications /></button>

                <button><img src={darkModeIcon} alt="" width={25} /></button>

                <button className='pl-2'><img src={profileIcon} alt="" width={35} /></button>
            </div>
        </header> 
    );
}
