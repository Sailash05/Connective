    ...
    return(
        <div className="bg-white rounded-2xl py-3 md:py-4 px-4 md:px-8 dark:bg-slate-900 shadow-md shadow-blue-100 dark:shadow-slate-800">
            ...
            <div className='mt-4 pl-4 flex gap-4'>
                <button onClick={() => setCreatePost(true)}><img src={addImageIcon} alt="" className='dark:invert hover:scale-110 transition-all w-5 md:w-6' /></button>
                <button onClick={() => setCreatePost(true)}><img src={addVideoIcon} alt="" className='dark:invert hover:scale-110 transition-all w-5 md:w-6' /></button>
                <button onClick={() => setCreatePost(true)}><img src={addFileIcon} alt="" className='dark:invert hover:scale-110 transition-all w-5 md:w-6' /></button>
                <button onClick={() => setCreatePost(true)}><img src={addLinkIcon} alt="" className='dark:invert hover:scale-110 transition-all w-5 md:w-6' /></button>
                <button onClick={() => setCreatePost(true)} className='ml-auto py-1 px-4 md:py-2 md:px-6 rounded-full bg-blue-600 hover:bg-blue-800 transition-all text-white font-bold'>Post</button>
            </div>
        </div>
    );
}
