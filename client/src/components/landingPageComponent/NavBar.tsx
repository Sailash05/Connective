...
const NavBar = () => {
    ...
    return(
        <nav className="w-full fixed top-0 left-0 right-0 z-50 shadow-sm bg-white">
            <div className="w-[90%] md:w-[70%] mx-auto flex justify-between items-center gap-10 py-3 md:py-4 h-full">
                <h1 className="mr-auto text-2xl md:text-4xl font-extrabold text-blue-600 cursor-pointer">
                ...
                <button className="cursor-pointer">
                    <img src={lightModeIcon} alt="dark-mode icon" width={25} />
                </button>
                ...
                <button className='md:hidden text-3xl' onClick={handleMenubtn}>
                    {
            ...
            {
                menuOpen && (
                    <ul className="md:hidden flex flex-col items-center gap-6 py-6 bg-white shadow-md text-lg font-medium transition-transform duration-300">
