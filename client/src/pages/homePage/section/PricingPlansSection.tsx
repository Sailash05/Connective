...
const PricingPlansSection = () => {
    return (
        <section className="w-11/12 max-w-6xl mx-auto py-6 md:py-12">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-2 md:mb-4">Choose Your Plan</h2>
            <p className="text-center text-gray-500 mb-7 md:mb-14 max-w-xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-5 md:gap-10">
                {
                    plans.map((plan, index) => (
                        <div key={index} className={`rounded-3xl p-8 shadow-lg  border ${plan.highlight
