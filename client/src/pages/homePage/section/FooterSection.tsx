...
const FooterSection = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 mt-20 pt-14 text-sm font-medium">
      <div className="w-11/12 max-w-6xl mx-auto grid md:grid-cols-4 sm:grid-cols-2 gap-10 border-b border-gray-800 pb-10">
        {/* Brand */}
        <div>
