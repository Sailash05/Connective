        ...
        <section id={id} className="min-h-[100dvh] h-fit md:h-[100dvh] pt-[5rem]">
            <div className="md:flex md:flex-row-reverse w-[90%] md:w-[70%] mx-auto h-fit">
                ...
                <div className="md:w-1/2 flex flex-col justify-center">
                    ...
                    <p className="text-slate-700 pb-4 md:pb-8">Join a growing network of professionals, creators, and learners. Discover communities, share your ideas, and grow together in a space designed for collaboration.</p>
            ...
            {/* Stats section */}
            <div className="mt-12 md:mt-0 max-sm:flex-wrap max-sm:gap-2 w-[90%] md:w-7/10 flex justify-between mx-auto">
                {
