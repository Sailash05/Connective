...
const SignUpSection = ({
    ...
    return(
        <div className='mt-2'>
            ...
            <button onClick={() => window.location.href = `${BACKEND_URL}/api/auth/google`} className='bg-white border border-blue-600 hover:bg-gray-100 transition-all w-full py-2 px-2 rounded-lg mb-2 flex items-center'>
